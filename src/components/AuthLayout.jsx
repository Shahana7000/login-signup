  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-[10%] -left-[5%] w-[50%] pt-[50%] border border-[#f5ecce] rounded-full opacity-60"></div>
        <div className="absolute top-[10%] -right-[10%] w-[40%] pt-[40%] border border-[#f5ecce] rounded-full opacity-60"></div>
      </div>
